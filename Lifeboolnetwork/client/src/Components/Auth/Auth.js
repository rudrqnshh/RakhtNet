...
const Auth = (props) => {
    ...
    const signUp = async (e) => {
        ...
        try {
            ...
            await axios.post(`auth/${handle}`, formData);
            await getLoggedIn();
            navigate(`/${handle == "bank" ? handle : "user"}/profile`);
        } catch (err) {
            alert(err.response?.data?.errorMessage || "An error occurred during signup");
        }
    };
    ...
    const logIn = async (e) => {
        ...
        try {
            ...
            await axios.post(`auth/login/${handle}`, formData);
            await getLoggedIn();
            navigate(`/${handle == "bank" ? handle : "user"}/profile`);
        } catch (err) {
            alert(err.response?.data?.errorMessage || "An error occurred during login");
        }
    }
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                        ...
                                        handle === "bank" ?
                                            <>
                                                ...
                                                <div>
                                                    ...
                                                    /></div>
                                                <div><label htmlFor="category" className="font-semibold  leading-8">Category:<font color="red">*</font></label>
                                    ...
                                    }
                                    {
                                        handle !== "bank" && <><div><label className="font-semibold  leading-8">Age:<font color="red">*</font></label>
                                            ...
                                            /></div>
                                            <div><label htmlFor="gender" className="font-semibold  leading-8">Gender:<font color="red">*</font></label>
